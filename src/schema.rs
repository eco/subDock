...
pub const MONGO_INDEXES: &[MongoIndexSpec] = &[
    ...
    // Withdrawal indexes
    MongoIndexSpec { collection: WITHDRAWAL_COLLECTION, field: "intent_hash", unique: false },
    ...
    // Refund indexes
    MongoIndexSpec { collection: REFUND_COLLECTION, field: "intent_hash", unique: false },
